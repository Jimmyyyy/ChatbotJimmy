...
public class IvanBooks implements Chatbot {
	...
	public String[] Series = { "Harry Potter, Demonata, and Cirque Du Freak ",
			"Sherlock Holmes and The Girl With the Dragon Tattoo ", "Goosebumps," };
	...
	public void talk() {
		...
		while (inMainLoop) {
			...
			while (inAntLoop) {
				...
				readA = JimmyMain.promptInput();
				JimmyMain.print("Oh, you like to read the genre, " + readA + "."
						+ "I don't want to talk about that one right now !" + "How about we talk about " + Genre[number]
						+ "?" + "Let me recommend you some " + Genre[number] + "novels!");
